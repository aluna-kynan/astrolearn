...
"[project]/app/join/hangar/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function JoinHangarPage() {
    ...
    const selectSpaceship = (shipId)=>{
        const ship = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["spaceships"].find((s)=>s.id === shipId);
        if (ship) {
            setGameState((prev)=>({
                    ...prev,
    ...
    const joinAndWait = ()=>{
        ...
        const player = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gameSession$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["joinGameSession"])(gameCode, gameState.playerName, gameState.selectedSpaceship);
        if (!player) {
        ...
        // Save current player
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gameSession$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["setCurrentPlayer"])(player);
        // Prepare questions for when game starts
        let questions;
        if (gameState.selectedTopicId) {
            const topicQuestions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$quizData$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getQuestionsByTopicAndCount"])(gameState.selectedTopicId, gameState.selectedQuestions);
            questions = topicQuestions.map((q)=>({
                    ...q,
                    difficulty: gameState.selectedDifficulty
                })).sort(()=>Math.random() - 0.5);
        } else {
            const allQuestions = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["quizQuestions"][gameState.selectedDifficulty];
            const shuffled = [
                ...allQuestions
            ].sort(()=>Math.random() - 0.5);
...
//# sourceMappingURL=_b54e0d28._.js.map